(() => {
  ...
  var ExampleTopLeftToolbar = ({ react }) => {
  ...
  var ExampleBottomRightToolbar = ({ react, setupController }) => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { className: "spacer_oEi" }), /* @__PURE__ */ import_react.default.createElement("button", { onMouseEnter, onMouseLeave, onClick, class: "button_s2g button_ECf item_It6 item-mouse-states_Fmi item-selected_tAM item-focused_FuT button_s2g button_ECf item_It6 item-mouse-states_Fmi item-selected_tAM item-focused_FuT toggle-states_X82 toggle-states_DTm" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "fa fa-solid-toolbox icon-lg" }), /* @__PURE__ */ import_react.default.createElement(ToolTip, { visible: tooltipVisible, float: "up", align: "right" }, /* @__PURE__ */ import_react.default.createElement(ToolTipContent, { title: "Test", description: "Hello, world!" }))));
  };
  window.$_gooee.register("example", "ExampleBottomRightToolbar", ExampleBottomRightToolbar, "bottom-right-toolbar", "example");
  var ExampleBottomLeftToolbar = ({ react }) => {
    const [tooltipVisible, setTooltipVisible] = react.useState(false);
    const onMouseEnter = () => {
      setTooltipVisible(true);
      engine.trigger("audio.playSound", "hover-item", 1);
  ...
  var ExampleMainContainer = ({ react, setupController }) => {
    ...
    const tabs = [
      ...
      {
        name: "TWO",
        label: /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "fa fa-solid-person" })),
        content: /* @__PURE__ */ import_react.default.createElement("div", null, "Test")
      },
      {
        name: "THREE",
        label: /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "fa fa-solid-lungs" })),
        content: /* @__PURE__ */ import_react.default.createElement("div", null, "Test")
      }
    ];
    const closeModal = () => {
